...
class LiquidateBorrowThread(Thread):
    ...
    def liquidate_borrow(self, addr):
        ...
        if owe_value > LIQUIDATE_LIMIT:
            ...
            liquidate_value = liquidate_value - 1000
            ...
            try:
                ...
                print("error", addr, liquidate_value, self.client.bank_get_total_borrow_value(addr) - self.client.bank_get_total_collateral_value(addr))
            finally:
